...
export default function Signup() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            // For simplicity in this demo, we can just redirect to login or show a success message.
            // In a real app with email confirmation, you'd show a "Check your email" message.
            // But Supabase often defaults to auto-confirm in dev, or we can just explain it.
        ...
        <div className="flex justify-center items-center min-h-[80vh]">
            <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500">Join RoomFinder to start listing or searching.</p>
                </div>
                ...
                <form onSubmit={handleSignup} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
